      ...
      if (dt_basic_table.length) { 
        var dt_basic = dt_basic_table.DataTable({
          ...
          columns: [
                { data: 'id' },
                { data: 'PROGR_Nombre' },
                { data: 'PROGR_Modalidad'},
                { data: 'PROGR_Tipo_Formacion'},
                { data: 'PROGR_Duracion'},
                { data: 'PROGR_Version'},
                { data: 'PROGR_Nivel'},
                { data: 'SECTO_Nombre'},
          ...
          columnDefs: [
            ...
            },
            {
              ...
              render: function (data, type, full, meta) {
                ...
                var id = full ['id'];
                var PROGR_URL = full ['PROGR_URL'];
                var url = '{{route('ViewUpdateProgramaForm', 'id')}}';
                url = url.replace('id', id);
                var url2 = '{{route('DeleteProgramaForm', 'id')}}';
                url2 = url2.replace('id', id);
                var pdf = '{{asset('storage/' . 'PROGR_URL')}}'  ;
                pdf = pdf.replace('PROGR_URL', PROGR_URL);
