    ...
    $(function () {
      ...
      if (dt_basic_table.length) {
        var dt_basic = dt_basic_table.DataTable({
          ...
          columns: [
                { data: 'id' },
                { data: 'FICHA_Identificador_Unico' },
                { data: 'FICHA_Fecha_Inicio' },
                { data: 'FICHA_Fecha_Terminacion' },
                { data: 'FICHA_Etapa' },
                { data: 'FICHA_Nombre_Responsable' },
                { data: 'JORNA_Nombre' },
                { data: 'PROGR_Nombre' },
                { data: 'CENTR_Nombre' },
                { data: 'Acciones' },
          ...
          columnDefs: [
            ...
            },
            {
              ...
              render: function (data, type, full, meta) {
                ...
                var id = full ['id'];
                var url = '{{route('ViewUpdateFicha', 'id')}}';
        ...
        $('div.head-label').html('<h6 class="mb-0">Listado de Ficha</h6>');
      }
