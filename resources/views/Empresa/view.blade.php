...
<script>
  function borrar(id){
    var url2 = '{{route('DeleteEmpresa', 'id')}}';
      ...
      if (dt_basic_table.length) {
        var dt_basic = dt_basic_table.DataTable({
          ...
          columns: [
                { data: 'id' },
                { data: 'EMPRE_Nombre' },
                { data: 'EMPRE_Tipo_Identificacion' },
                { data: 'EMPRE_Id_Empresa' },
                { data: 'Acciones' },
              ],
          columnDefs: [
            {
            ...
            },
            {
              ...
              render: function (data, type, full, meta) {
                ...
                var id = full ['id'];
                var url = '{{route('ViewUpdateEmpresa', 'id')}}';
        ...
        $('div.head-label').html('<h6 class="mb-0">Listado de Empresa</h6>');
      }
