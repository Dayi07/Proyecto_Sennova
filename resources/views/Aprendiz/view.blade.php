...
<script>
  function borrar(id){
    var url2 = '{{route('DeleteAprendiz', 'id')}}';
      ...
      if (dt_basic_table.length) {
        var dt_basic = dt_basic_table.DataTable({
          ...
          columns: [
                { data: 'id' },
                { data: 'APREN_Nombre' },
                { data: 'APREN_Tipo_Documento' },
                { data: 'APREN_Documento' },
                { data: 'APREN_Genero' },
                { data: 'APREN_Correo' },
                { data: 'APREN_Estado' },
                { data: 'APREN_Telefono' },
          ...
          columnDefs: [
            ...
            },
            {
              ...
              render: function (data, type, full, meta) {
                ...
                var id = full ['id'];
                var url = '{{route('ViewUpdateAprendiz', 'id')}}';
        ...
        $('div.head-label').html('<h6 class="mb-0">Listado de Aprendiz</h6>');
      }
