                ...
                <div class="row">
                    ...
                    <div class="card">
                         <table class="table table-hover">
                            ...
                            <tr>
                                @foreach ($hor as $item)       
                                <td>{{ $item->HORAS_Monitores }} </td> 
                                <td>{{ $item->HORAS_Inst_Empresa }} </td> 
                                <td>{{ $item->HORAS_Contratista_Externo }} </td> 
                                <td>{{ $item->HORAS_Planta }} </td> 
                                <td>{{ $item->HORAS_Total }} </td> 
                                <td>{{ $item->OCUPA_Nombre }} </td> 
                                <td>
                                    ...
                                    <a href=" {{ route('ViewUpdateHora', $item->id) }}">
