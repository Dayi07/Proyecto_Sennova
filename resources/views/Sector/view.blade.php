                    ...
                    <div class="col-12">
                      <h2 class="content-header-title float-start mb-0">Sector</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('ViewSector') }}">Listado de Programas</a>
                                </li>
...
<script>
  function borrar(id){
    var url2 = '{{route('DeleteSector', 'id')}}';
...
<script>
    $(function () {
      ...
      if (dt_basic_table.length) {
          ...
          columnDefs: [
            ...
            },
            {
              ...
              render: function (data, type, full, meta) {
                ...
                var id = full ['id'];
                var url = '{{route('DatosUpdateSector', 'id')}}';
        ...
        $('div.head-label').html('<h6 class="mb-0">Listado de Sectores</h6>');
      }
