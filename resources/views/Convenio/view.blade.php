...
<script>
  function borrar(id){
    var url2 = '{{route('DeleteConvenio', 'id')}}';
      ...
      if (dt_basic_table.length) {
        var dt_basic = dt_basic_table.DataTable({
          ...
          columns: [
                { data: 'id' },
                { data: 'CONVE_Nombre' },
                { data: 'CONVE_Ampliacion_Covertura'},
                { data: 'SECTO_Nombre'},
                { data: 'EMPRE_Nombre'},
                { data: 'Acciones' },
              ],
          columnDefs: [
            ...
            },
            {
              ...
              render: function (data, type, full, meta) {
                ...
                var id = full ['id'];
                var url = '{{route('ViewUpdateConvenio', 'id')}}';
        ...
        $('div.head-label').html('<h6 class="mb-0">Listado de Convenios</h6>');
      }
